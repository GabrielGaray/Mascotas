...
import { NuevaRazaComponent } from "./raza/nueva-raza.component";
...
export const routes: Routes = [
    ...
    { path: "razas", component: RazaComponent, canActivate: [LoggedIn]},
    { path: "nuevaRaza", component: NuevaRazaComponent, canActivate: [LoggedIn]},
    { path: "nuevaRaza/:id", component: NuevaRazaComponent, canActivate: [LoggedIn]}
];
